...
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
CFE_Status_t UTRX_APP_TblValidationFunc(void *TblData)
{
    CFE_Status_t               ReturnCode = CFE_SUCCESS;
    UTRX_APP_ExampleTable_t *TblDataPtr = (UTRX_APP_ExampleTable_t *)TblData;

    /*
    ** Sample Example Table Validation
    */
    if (TblDataPtr->Int1 > UTRX_APP_TBL_ELEMENT_1_MAX)
    {
        /* First element is out of range, return an appropriate error code */
        ReturnCode = UTRX_APP_TABLE_OUT_OF_RANGE_ERR_CODE;
    }
...
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
void UTRX_APP_GetCrc(const char *TableName)
{
    CFE_Status_t   status;
    uint32         Crc;
